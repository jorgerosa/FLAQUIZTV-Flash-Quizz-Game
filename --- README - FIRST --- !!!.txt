...
Project name: FlaQuizTV
Developed using: "Adobe Flash CS3 Professional"
Features: "TOUCH SCREEN" READY! ;)

FlaQuizTV - All copyrights reserved to Jorge Rosa - email: jorge.bigarte@gmail.com
Portfolio: http://sites.google.com/site/jorgerosaportfolio
Download game: http://sourceforge.net/projects/flaquiztv
Please, send feedback or comments. Thankyou!

Some pictures related to the included questions as examples, were taken from internet, their copyrights (if any) belong to their owners.
...
1) Extract the ".zip" file, and run "game.exe"... That´s all!

2) OR run "game.swf" ("game.swf" will play in your internet browser, but only if it has the flash plugin).
...
3) Edit the "settings.txt" file and Save. (restart game - Recommended: Create a backup of this file first!)
